...
*
*   Purpose: Defines the debugger side class for DataContractVisualizer.
*
*   Notes:
*
...
[assembly: DebuggerVisualizer(typeof(DebuggerSideDataContractVisualizer),
    ...
    TargetTypeName =
        "DebuggerUtility.Visualizers.Tests.MyDataContract, DebuggerUtility.Visualizers.Tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null",
...
namespace DebuggerUtility.Visualizers.DataContract
{
    ...
    public class DebuggerSideDataContractVisualizer : DebuggerSideVisualizer
    {
        ...
        /// </summary>
        private const string VISUALIZER_NAME = "DataContract Visualizer";
